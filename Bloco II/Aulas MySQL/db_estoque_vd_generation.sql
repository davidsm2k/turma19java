...
SELECT * FROM tb_marcas WHERE nome = "NIKE";
SELECT nome, ativo FROM tb_marcas;
SELECT nome, ativo FROM tb_marcas WHERE id = 1;
SELECT * FROM tb_marcas WHERE nome LIKE "%ar%"; -- LIKE pesquisa todos que tiverem o padrão solicitado
...
UPDATE tb_produtos SET nome = "Tênis" WHERE id = 2;