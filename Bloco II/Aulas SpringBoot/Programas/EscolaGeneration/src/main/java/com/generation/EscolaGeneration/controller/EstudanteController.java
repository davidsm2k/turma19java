...
public class EstudanteController {
	...
	@GetMapping
	private ResponseEntity<List<Estudante>> GetAll() {
		return ResponseEntity.ok(repository.findAll());
	}
	
	@GetMapping("/{id}")
	private ResponseEntity<Estudante> GeyById(@PathVariable long id){
	...
	@PutMapping
	private ResponseEntity<Estudante> put(@RequestBody Estudante estudante){
