...
public class CadastroClienteLoja {
	public static void main(String[] args) {
		...
		if(cli1.calcularIdade() > cli2.calcularIdade()) {
			System.out.printf("\n%s %s %s é a pessoa mais velha", cli1.trasArtigo().toUpperCase(), cli1.tratamento(), cli1.nome, cli1.calcularIdade());
		}
		else {
			System.out.printf("\n%s %s %s é a pessoa mais velha", cli2.trasArtigo().toUpperCase(), cli2.tratamento(), cli2.nome, cli2.calcularIdade());
		}
		//*****************************************************
	}
}
